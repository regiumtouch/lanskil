...
const QUESTIONS = [
  ...
  {
    id: 2,
    text: "A SaaS landing page hero for a project-management tool. Four grammatically-correct headlines. Which reflects Tier III category-design thinking most cleanly?",
    options: [
      { text: "\"Welcome to [brand] — rethink how you work\"", score: 1 },
      { text: "\"The fastest project management tool for modern teams\"", score: 2 },
      { text: "\"Save 4 hours a week with streamlined workflows\"", score: 3 },
      { text: "\"Most PM tools are calendars. We built a decision-making OS. Here's why.\"", score: 4 },
    ],
  },
  {
    id: 3,
    text: "Eugene Schwartz's 5 Levels of Awareness (Unaware → Problem Aware → Solution Aware → Product Aware → Most Aware) most directly determines which element of your copy?",
    options: [
      { text: "Sentence length and pacing", score: 1 },
      { text: "Call-to-action wording", score: 2 },
      { text: "Visual design and layout", score: 1 },
      { text: "The LEAD — what promise, hook, or angle you open with. A lead to an Unaware audience is fundamentally different from a lead to a Most Aware one; wrong lead = copy that can't convert regardless of craft below it", score: 4 },
    ],
  },
  {
    id: 4,
    text: "A B2B pricing page converts at 1.8%. You add an ROI calculator directly beside the price tier — nothing else changes. Conversion lifts to 2.9%. The single principle that most cleanly explains the lift:",
    options: [
      { text: "Social proof", score: 1 },
      { text: "Urgency", score: 1 },
      { text: "Anchoring bias", score: 2 },
      { text: "Collapsing the price-justification gap. The moment a buyer sees price is the moment they need payback math. Any distance (scroll, click, email, call) bleeds commitment between question and answer", score: 4 },
    ],
  },
  {
    id: 5,
    text: "You're rewriting a founder's post that a reader called \"obviously AI-drafted.\" The single highest-leverage change is:",
    options: [
      { text: "Shorten the sentences", score: 1 },
      { text: "Add em-dashes for rhythm", score: 1 },
      { text: "Remove adjective stacks like \"innovative, cutting-edge, seamless\"", score: 3 },
      { text: "Reverse the structure — lead with the specific, surprising, concrete detail; bury the thesis at the end. AI's default is to front-load the summary; human writing earns attention by starting with an image, a number, or a contrarian observation", score: 4 },
    ],
  },
  {
    id: 6,
    text: "A freelance copywriter at $180K/yr — 60% client delivery, 30% acquisition, 10% craft. Which Tier III move compounds earnings most over 5 years?",
    options: [
      { text: "Raise rates 20% across the board", score: 2 },
      { text: "Hire a junior copywriter to delegate delivery", score: 2 },
      { text: "Niche down and turn away non-fit clients", score: 3 },
      { text: "Drop to 2-3 retainer clients + build a paid community that compounds audience + creates referrals with near-zero new acquisition time", score: 4 },
    ],
  },
  {
    id: 7,
    text: "A $1,997 course launch with a 5-day cart window. A Tier III email sequence for launch week looks like:",
    options: [
      { text: "1-2 announcement emails — restraint signals quality", score: 1 },
      { text: "3-4 emails spaced evenly across the week", score: 2 },
      { text: "30+ emails — daily plus multiple daily on cart-close", score: 2 },
      { text: "6-10 emails with escalating urgency, doubles on cart-close day, a 3-hour-warning email, final \"cart closing\" — the last 24 hours typically produce more revenue than the first 4 days combined", score: 4 },
    ],
  },
  {
    id: 8,
    text: "A B2B engagement: landing page + email sequence, ~6 weeks of work, generates $420K attributable pipeline in the first 6 months. The most Tier III fee structure:",
    options: [
      { text: "Hourly billing at $250/hr", score: 1 },
      { text: "One-time project fee of $18K", score: 2 },
      { text: "20% upfront + 80% on creative delivery", score: 2 },
      { text: "Initial $8K + $10K at 30 days + a 2% rev-share on attributable pipeline over 6 months — ties compensation to outcome and creates ongoing optimisation incentive for both sides", score: 4 },
    ],
  },
  {
    id: 9,
    text: "A SaaS at $4M ARR wants to 2× email revenue. Your diagnostic Week 1 focuses on:",
    options: [
      { text: "Writing better individual emails", score: 2 },
      { text: "Adding lead-capture pop-ups to grow the list", score: 1 },
      { text: "Running A/B tests on subject lines", score: 2 },
      { text: "Auditing existing flows: deliverability, segment engagement, offer-to-segment fit, welcome-sequence conversion. 2× rarely comes from \"write better emails\" — it usually comes from fixing a broken foundation the team stopped looking at", score: 4 },
    ],
  },
  {
    id: 10,
    text: "\"The commodity 80%\" in AI-assisted copywriting refers to:",
    options: [
      { text: "The 80% of drafts that readers skim past", score: 1 },
      { text: "The 80% of copy that ends up cut during editing", score: 1 },
      { text: "The 80% of revenue from the top 20% of emails (Pareto)", score: 2 },
      { text: "The 80% of drafting work that is structural, repetitive, or compressive — where AI is a force multiplier without diluting voice. The remaining 20% (specifics, proof, voice, contrarian positioning) stays human", score: 4 },
    ],
  },
];
