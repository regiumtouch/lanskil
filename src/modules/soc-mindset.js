...
export const socMindsetModule = {
  ...
  quiz: [
    { q: "Two LinkedIn posts from the same brand: Post A has 6,200 impressions / 18 engagements (0.29% rate). Post B has 2,100 impressions / 47 engagements (2.24%). Which one does the algorithm reward further in the next 48 hours, and why?", opts: ["A \u2014 raw impressions signal distribution health", "A \u2014 since more people saw it, the content is objectively stronger", "B \u2014 engagement rate is what the ranker propagates; A\u2019s low rate tells LinkedIn the audience saw the post and skipped, which caps future reach", "Neither \u2014 ranking is random after 24 hours"], correct: 2 },
    { q: "A compliance-software company has bandwidth for one primary channel. Buyer: CISO at a 500\u20132000-person enterprise. Which choice is most defensible and why?", opts: ["LinkedIn \u2014 the CISO\u2019s scroll moment on this platform is credibility-seeking, and enterprise buyers already sit there in a work mindset", "TikTok \u2014 short-form is where all attention is moving; category rules don\u2019t matter anymore", "Facebook Groups \u2014 enterprise buying happens through community referrals", "Instagram Reels \u2014 visual storytelling cuts through any category"], correct: 0 },
    { q: "Calendar audit: 68% promotion, 20% culture, 8% education, 4% community. Reach has fallen 40% over 8 weeks. Which reframe best explains the decline?", opts: ["The audience got tired of the brand voice \u2014 rewrite the voice guide", "Posting frequency dropped below an algorithmic threshold", "Competitors launched the same week and cannibalised share of voice", "Save-worthy value + engagement posts are what earn future reach; a 76% promo/culture mix teaches the algorithm this account produces low-save content, so future posts get throttled"], correct: 3 },
    { q: "Which post is the strongest example of \u201cadvocacy\u201d on the content spectrum?", opts: ["\u201cOur Q2 report is live \u2014 link in bio\u201d", "\u201cReposting Priya\u2019s thread \u2014 her team cut triage 14\u21922 min with our setup. Her words, not ours.\u201d", "\u201cHot take: cold email is dead\u201d", "\u201c5 reasons every B2B team needs CRM hygiene\u201d"], correct: 1 },
    { q: "You\u2019re given two personas for writing LinkedIn copy: (A) \u201cMarketing Mary, 34, likes yoga, values authenticity\u201d and (B) \u201cHead of CS at a 50\u2013200 seat SaaS, end of quarter, just lost her Head of Support to a competitor.\u201d Which reliably produces sharper copy and why?", opts: ["A \u2014 lifestyle details build relatable voice", "Both are equally useful \u2014 persona format doesn\u2019t affect copy", "B \u2014 the scroll moment (end of quarter + fresh loss) gives a concrete trigger the hook can target", "A \u2014 demographic targeting matches ad-platform filters better"], correct: 2 },
    { q: "A brand must cross-post the exact same caption to LinkedIn, Instagram, and X. Which platform absorbs the LEAST performance penalty and why?", opts: ["X \u2014 short copy is already native, so the mismatch penalty is smallest relative to where format + length expectations are more specific", "Instagram \u2014 the visual carries the caption so generic copy is masked", "LinkedIn \u2014 its audience reads more tolerantly", "They suffer equally \u2014 every platform punishes non-native copy the same"], correct: 0 },
  ],
  slides: [
