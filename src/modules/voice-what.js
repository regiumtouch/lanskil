...
export const voiceWhatModule = {
  ...
  quiz: [
    { q: "You audit a brand's LinkedIn (CEO writes: punchy, first-person, contrarian claims with numbers) and its blog (marketing team writes: measured, third-person, consensus opinions). Your diagnosis:", opts: ["Rewrite the blog to match the CEO \u2014 consistency matters", "Rewrite the CEO to match the blog \u2014 more professional", "Different tones are fine; the real question is whether the underlying POV + vocabulary + refusals are shared. If blog and CEO stake different beliefs, THAT is the voice problem, not the rhythm difference", "Pick one voice; use everywhere"], correct: 2 },
    { q: "A brand's voice guide reads: \"We are warm, smart, authoritative, and approachable.\" Every competitor's guide says something similar. The structural problem:", opts: ["Too few adjectives", "Adjectives don't tell writers what to DO; specific choices (sentence length, vocabulary, POV, refusals, signature moves) do. Competitor brands describing themselves the same way proves adjectives aren't distinguishing anyone", "Wrong adjectives", "Length issue"], correct: 1 },
    { q: "You remove the brand name from a company's landing page. Someone familiar with the category reads it and cannot guess which company. This proves:", opts: ["The copy is well-written", "The brand has no voice \u2014 voice, properly built, is a fingerprint; if the copy could describe 5 competitors, the brand failed the blind test and hasn't staked anything distinctive", "Blind tests don't work", "Voice is overrated"], correct: 1 },
    { q: "Which is the strongest source for authentic brand voice?", opts: ["A creative workshop with an external agency", "Competitor analysis to find whitespace", "Transcripts of founder podcasts + sales call recordings + customer interviews \u2014 real human communication reveals real POV, real vocabulary, real refusals; synthetic voices don't survive blind tests", "A list of aspirational adjectives"], correct: 2 },
    { q: "\"Voice\" vs \"tone\" distinction, correctly applied:", opts: ["They're the same thing", "Voice = durable (POV, vocabulary, signature moves); tone = situational (celebratory on launch, somber on outage). If your voice changes with situation, you have improvisation, not voice", "Voice is spoken, tone is written", "Tone is for emails, voice is for blogs"], correct: 1 },
    { q: "A brand insists on \"neutral, objective voice \u2014 we don't take sides.\" The commercial consequence over 3 years:", opts: ["Broader appeal, more sales", "Indistinguishable from every competitor making the same neutrality claim; neutral voice is absence of voice, and absent voices don't compound or retain customers at the rate committed ones do", "Stronger legal position", "Easier to manage"], correct: 1 },
  ],
  slides: [
