...
export const socCtaModule = {
  ...
  quiz: [
    { q: "A post ends: \u201cDrop \ud83d\udd25 if this resonates, comment below with your thoughts, share if it helps, and follow for more!\u201d Comment count is 3 on 12k impressions. Most likely reason?", opts: ["Too few emojis", "Wrong hashtags", "Four competing CTAs fragment the decision \u2014 one specific ask consistently beats four vague ones because the reader only spends a split-second choosing an action", "Wrong posting time"], correct: 2 },
    { q: "A B2B post: 8,000 impressions, 62 likes, 3 comments, 14 saves. Which metric is the strongest positive signal here, and why?", opts: ["Likes \u2014 62 means 0.77% positive sentiment", "Save rate \u2014 14 saves on 8,000 impressions (0.18%) is unusually high for a B2B post, and save behaviour signals reference-worthiness, which LinkedIn\u2019s ranker weights heavily", "Comments \u2014 3 is a clear community signal", "None of these metrics matter; only impressions do"], correct: 1 },
    { q: "You\u2019re running a mid-funnel post aimed at growing the email list. Which CTA best matches the funnel stage?", opts: ["\u201cComment \u2018template\u2019 and I\u2019ll DM you the full PDF \u2014 opt in when you get the message.\u201d", "\u201cBuy now!\u201d", "\u201cThoughts?\u201d", "\u201cFollow for more content\u201d"], correct: 0 },
    { q: "The psychology that reliably drives shares on social is:", opts: ["Shareholders want likes on their shares", "Platforms pay users for shares", "Shares are random", "Social currency \u2014 sharing the post makes the sharer look smart, caring, informed, or ahead to their own network, so the share benefits them too"], correct: 3 },
    { q: "A creator swaps \u201cWhat do you think?\u201d for \u201cOne-word answer below: which would you cut first \u2014 meetings, Slack, or email?\u201d Comments jump 5\u00d7. The mechanism is:", opts: ["The new question is shorter", "The algorithm randomly favoured it", "Specific multiple-choice framing + one-word commitment drastically lowers the cognitive cost of leaving a comment", "Emojis did the work"], correct: 2 },
    { q: "Which reply practice most consistently drives additional reach to YOUR post, not just goodwill?", opts: ["\u201cThanks!\u201d to every comment", "Reply with a follow-up question that invites more back-and-forth, within the first 60 minutes \u2014 conversation depth in the first hour is a strong ranker input", "Only replying to positive comments", "Batching replies once a week"], correct: 1 },
  ],
  slides: [
