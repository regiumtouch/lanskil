...
export const socCtaModule = {
  ...
  quiz: [
    { q: "A post ends with: \"Drop \ud83d\udd25 if this resonates, comment below with your thoughts, share if it helps, and follow for more!\" Comments are low. Why?", opts: ["Too few emojis", "Four competing CTAs dilute decision \u2014 one specific ask converts far better than four vague ones", "Not enough hashtags", "Wrong posting time"], correct: 1 },
    { q: "You have a B2B post with 8,000 impressions, 62 likes, 3 comments, and 14 saves. What does that save-to-engagement ratio most likely indicate?", opts: ["The post is failing", "The content is reference-worthy (framework, checklist) \u2014 the save rate is actually the strongest signal here, and the algorithm treats saves heavily", "The post is boring", "Not enough emojis"], correct: 1 },
    { q: "Which CTA best matches a mid-funnel post aimed at building email list?", opts: ['"Buy now!"', '"Comment \u2018template\u2019 and I\u2019ll DM you the full PDF"', '"Thoughts?"', '"Follow for more content"'], correct: 1 },
    { q: "What is the underlying mechanic behind \"social currency\" that drives shares?", opts: ["Users want likes on their shares", "Sharing your post makes the sharer look smart, caring, informed, or ahead of the curve to their own network \u2014 they benefit from the share socially", "Platforms pay for shares", "Shares are random"], correct: 1 },
    { q: "A creator switches from \"What do you think?\" to \"One-word answer below: which would you cut first \u2014 meetings, Slack, or email?\" Comments jump 5\u00D7. Why?", opts: ["The new question is shorter", "Specific multiple-choice framing + one-word commitment drastically lowers the barrier to commenting", "The algorithm randomly favoured it", "Emojis were added"], correct: 1 },
    { q: "When replying to comments on your post, which practice most consistently drives additional reach?", opts: ["Reply with \"Thanks!\" to every comment", "Reply with a follow-up question that invites more back-and-forth, within the first 60 minutes", "Reply only to positive comments", "Batch replies once a week"], correct: 1 },
  ],
  slides: [
