...
export const convObjectionsModule = {
  ...
  quiz: [
    { q: "Your pricing objection answer currently lives in the footer FAQ. Where should it live, and why?", opts: ["Within ~150px of the price itself \u2014 the objection fires the moment the visitor sees the number, and the answer must dissolve it in the same glance, not a scroll away", "In the footer FAQ \u2014 that\u2019s the convention", "On a separate FAQ page", "Inside the privacy policy"], correct: 0 },
    { q: "You add a FAQ at the bottom of a long landing page. Scroll-depth data shows 80% of visitors never reach it. Better move?", opts: ["Leave it \u2014 FAQs are for the 20% who care", "Make the FAQ longer and more detailed", "Inline the top 3 objection answers at the exact points where each objection naturally arises (price, implementation, trust) so they fire when the visitor is thinking about them", "Delete all FAQs"], correct: 2 },
    { q: "\u201cContact sales for pricing\u201d typically creates which compound objection?", opts: ["No objection \u2014 it filters serious buyers", "\u201cToo simple for my company\u201d", "\u201cNot enterprise enough\u201d", "\u201cIt must be expensive\u201d AND \u201cI have to run a gauntlet before I can even know\u201d \u2014 hiding price often creates a larger objection than any specific number would have"], correct: 3 },
    { q: "A B2B buyer sees your price and thinks \u201ctoo expensive.\u201d Your copy says \u201caffordable for all budgets.\u201d Likely impact on conversion?", opts: ["Positive \u2014 reassuring language helps", "Negative or neutral \u2014 \u201caffordable\u201d is unfalsifiable and answers nothing specific; replace with ROI math or payback period tied to their stage", "Strongly positive", "No effect \u2014 price objections are fixed"], correct: 1 },
    { q: "Implementation fear is the objection that:", opts: ["Often kills more deals than sticker price \u2014 buyers fear the 6-month rollout they\u2019re imagining more than the monthly invoice", "Doesn\u2019t apply to SaaS", "Only exists in hardware categories", "Is solved automatically by testimonials"], correct: 0 },
    { q: "Effective risk reversal at the CTA should be:", opts: ["A paragraph buried in Terms of Service", "Generic \u201csatisfaction guarantee\u201d wording", "Specific, explicit, and within visible proximity of the CTA button \u2014 e.g., \u201c30-day refund, 1-click cancel, no sales call\u201d \u2014 not generic \u201csatisfaction guaranteed\u201d", "Omitted \u2014 it signals weakness"], correct: 2 },
  ],
  slides: [
