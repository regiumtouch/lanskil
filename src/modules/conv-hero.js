...
export const convHeroModule = {
  ...
  quiz: [
    { q: "Your hero headline reads: \u201cInnovative Solutions for Modern Teams.\u201d What\u2019s the sharpest diagnosis?", opts: ["Strong positioning \u2014 leave it", "Generic adjectives, no specific outcome, no named audience \u2014 the headline is invisible to any specific buyer; rewrite with role + constraint + result", "Wrong font weight", "Too short \u2014 make it longer"], correct: 1 },
    { q: "Which value-prop formula consistently tests highest in 2026 B2B?", opts: ["\u201c[Named Role] get [Specific Outcome] in [Specific Time] without [Common Pain]\u201d", "\u201c[Vague outcome] with our innovative platform\u201d", "\u201cThe best platform for modern businesses\u201d", "\u201cUnleash your potential\u201d"], correct: 0 },
    { q: "Your hero has a beautiful stock-photo illustration and vague copy. Conversion is 0.9%. The diagnostic rule:", opts: ["Add animation to the illustration", "Make the illustration bigger", "The hero visual must PROVE or DEMONSTRATE the outcome the copy promises; decorative illustrations add no conversion value \u2014 replace with product screenshot or named customer photo", "Switch to video"], correct: 2 },
    { q: "Primary CTA options. Rank by expected lift: (A) \u201cSign Up\u201d (B) \u201cStart free \u2014 no card, 90-sec setup\u201d (C) \u201cSubmit\u201d (D) \u201cTry for Free\u201d", opts: ["A > B > C > D", "D > B > A > C", "All four perform equivalently", "B \u226b A, C, D \u2014 B names benefit + removes two frictions + gives a concrete time anchor; the others are generic or ambiguous"], correct: 3 },
    { q: "Ranked by conversion impact above-the-fold: (A) headline (B) subhead (C) CTA copy (D) background image", opts: ["A > B > C > D", "A \u2248 C > B > D \u2014 headline matches intent; CTA seals action; subhead amplifies but is secondary; background image is usually noise", "D > A > B > C", "All equal"], correct: 1 },
    { q: "A visitor lands on your hero. Within 3 seconds, what three questions must they be able to answer?", opts: ["\u201cWho is this for?\u201d \u201cWhat do I get?\u201d \u201cWhat\u2019s the next step?\u201d \u2014 if any is unclear at 3s, you lose the visit", "How old is your company, who founded it, why now", "What\u2019s your founder\u2019s story, where are you based, what\u2019s your vision", "Pricing, refund policy, team size"], correct: 0 },
  ],
  slides: [
