...
export const socCalendarModule = {
  ...
  quiz: [
    { q: "A healthy social content mix is approximately:", opts: ["90% promotion, 10% other", "40% value / 30% engagement / 20% promotion / 10% culture", "50% jokes, 50% sales", "100% promotion"], correct: 1 },
    { q: "The single best metric for \u2018bookmark-worthy\u2019 content is:", opts: ["Likes", "Save rate (saves / reach)", "Follower count", "Hashtag performance"], correct: 1 },
    { q: "A good social A/B test varies:", opts: ["Everything at once \u2014 hooks, images, CTAs, posting time", "One element at a time \u2014 hook, CTA, format, or creative \u2014 with enough sample to be meaningful", "Only hashtags", "Only post timing"], correct: 1 },
    { q: "The weekly copy review ritual should answer:", opts: ["\u201CHow many pieces did we publish?\u201D", "\u201CWhich posts drove the primary outcome, and what pattern repeated in the winners?\u201D", "\u201CWhich competitor posted more than us?\u201D", "\u201CAre we using enough emojis?\u201D"], correct: 1 },
    { q: "AI is best used in a social workflow as:", opts: ["The replacement for the copywriter", "A brainstorming, rewriting, and outlining partner \u2014 but the final voice and angle must be human", "An automatic posting tool", "A free content generator"], correct: 1 },
    { q: "A 30-day content calendar should include, at minimum:", opts: ["Just publish dates", "Platform, post type, hook, full copy, CTA, and target metric per post", "Only the topic ideas", "Just which team member writes each"], correct: 1 },
  ],
  slides: [
