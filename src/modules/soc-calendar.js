...
export const socCalendarModule = {
  ...
  quiz: [
    { q: "Sample audit of 10 posts: 7 promo/launch, 2 culture, 1 education, 0 engagement. Engagement is falling MoM. Using the 40/30/20/10 frame, what\u2019s the specific corrective for the next 10 posts?", opts: ["Post more frequently \u2014 volume fixes engagement", "Rebalance to roughly 4 value + 3 engagement + 2 promotion + 1 culture, prioritising value/engagement first because they compound into the reach base", "Cut culture posts entirely and double promo", "Add paid boost to every post"], correct: 1 },
    { q: "Three LinkedIn posts: (A) 2% save / 8% like; (B) 6% save / 2% like; (C) 1% save / 12% like. Which is the strongest signal of compounding value and why?", opts: ["A \u2014 balanced metrics indicate broad appeal", "C \u2014 highest likes means highest resonance", "B \u2014 high save rate means readers treat the post as reference content; saves correlate with durable ranking boosts and return visits more than likes do", "All three are equivalent"], correct: 2 },
    { q: "A/B test: same body, Hook A vs Hook B, 3 posts each over 2 weeks. Hook A: 4.1% avg engagement. Hook B: 4.3%. Honest conclusion?", opts: ["Hook B wins \u2014 scale it", "Kill both hooks", "Run both forever without deciding", "Sample is too small \u2014 a 0.2-point gap across 6 posts sits inside noise; either keep testing or test a more differentiated variant"], correct: 3 },
    { q: "At a weekly review, a teammate leads with: \u201cWe published 12 posts this week \u2014 up from 9.\u201d What\u2019s wrong with that framing?", opts: ["Publishing volume is an input, not an outcome \u2014 a review should start with which posts moved the primary outcome metric and why, not how many went live", "The number should be higher", "Nothing \u2014 it\u2019s good news", "Posting more is always better"], correct: 0 },
    { q: "You\u2019re using AI to help produce a week of LinkedIn content. Which workflow is healthiest for long-term account quality?", opts: ["Let AI draft final posts and publish them unchanged", "Never touch AI", "Let AI write everything but change two words", "Use AI to brainstorm hooks and outlines, then write body + voice yourself \u2014 AI as junior copywriter, not final author"], correct: 3 },
    { q: "A monthly report to leadership: \u201c50K impressions, 200 likes, 12 posts, 3 comments.\u201d What\u2019s the biggest missing piece?", opts: ["More impressions breakdown", "Hashtag breakdowns by post", "Connection to a primary business outcome \u2014 DMs opened, signups, pipeline, revenue attributed to content \u2014 without it, leadership can\u2019t evaluate ROI", "Weekly trend charts"], correct: 2 },
  ],
  slides: [
