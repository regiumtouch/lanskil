...
export const cdMeasureModule = {
  ...
  quiz: [
    { q: "A campaign post-mortem reports: 3.1M impressions, 847 email signups, 12 press mentions \u2014 labelled a \"huge win.\" Pipeline impact: $0 attributable. Sharpest read:", opts: ["Impressions are the campaign's value \u2014 pipeline is lagging", "The campaign may have served a brand/authority goal effectively, but if the stated primary outcome was pipeline, the post-mortem is performative \u2014 vanity numbers are hiding a real gap, and next campaign's brief needs to either commit to brand as the primary goal or fix the conversion path", "Kill the program", "Wait 6 more months"], correct: 1 },
    { q: "Measuring a campaign vs measuring individual pieces differs fundamentally because:", opts: ["Only in scale \u2014 same metrics", "Campaigns compound across pieces; per-piece metrics miss the aggregated reach, the flagship's evergreen tail, the brand lift from category-named mentions, and the cross-piece sequencing effect \u2014 summing piece metrics systematically under-reports campaign value", "Campaigns don't need measurement", "Same methodology, longer window"], correct: 1 },
    { q: "For a B2B campaign, pick the honest pairing of leading + lagging indicators:", opts: ["Impressions + likes", "Qualified demo requests from campaign pages and email signups from campaign assets (leading) + content-attributed pipeline or revenue (lagging) \u2014 leading predicts lagging and lagging is what leadership cares about", "Follower growth + retweets", "Page views + time on page"], correct: 1 },
    { q: "A campaign underperforms. Most common actual root cause (before blaming execution):", opts: ["Team didn't work hard", "Frame misalignment \u2014 wrong audience, wrong stake, wrong primary outcome \u2014 rather than execution failure; diagnosing frame before execution prevents teams from getting better at running the wrong campaign harder", "Pieces were too short", "Bad writing"], correct: 1 },
    { q: "An honest post-mortem is distinguished from a performative one by:", opts: ["Length", "It names specific failures attributable to specific decisions (without blame), distinguishes frame failures from execution failures, and outputs 1\u20133 documented changes that become inputs to the next campaign's brief \u2014 performative post-mortems celebrate wins and change nothing", "Tone", "Who writes it"], correct: 1 },
    { q: "Leadership one-page campaign report. Most effective composition:", opts: ["All 20 metrics from the full dashboard", "One headline outcome vs target + 2 leading indicators + one named customer story + one honest failure + 1\u20133 concrete changes for next campaign \u2014 executives remember one number and one story, and the honest failure buys the team trust for the next budget cycle", "Impressions only", "A celebratory narrative"], correct: 1 },
  ],
  slides: [
