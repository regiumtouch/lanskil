...
export const socPaidModule = {
  ...
  quiz: [
    { q: "Your Meta ad has CTR 2.8% and CPA $142. Your benchmark is CTR 1.5% and CPA $55. What does this combination suggest?", opts: ["The ad is performing beautifully", "The hook works (people click) but the landing page or offer is underperforming \u2014 post-click, conversion breaks down. Investigate the landing page, not the ad copy", "The ad should be killed immediately", "The targeting is wrong"], correct: 1 },
    { q: "You have 5 Meta ad variants running. After 72 hours, Variant C has CTR 1.1%, CPA $190. Variants A, B, D, E range from CTR 2.1\u20133.4%, CPA $38\u201368. The correct next move is:", opts: ["Pause everything", "Kill C, let A/B/D/E keep learning, start planning new variants of the 2 clear top performers", "Increase all budgets equally", "Put all budget on C"], correct: 1 },
    { q: "A B2B TikTok Spark Ad opens with a polished voiceover intro: \"At AcmeCorp, we believe...\" It underperforms. Why?", opts: ["TikTok audiences don\u2019t buy B2B", "Spark Ads need UGC-style native opens with a pattern interrupt in the first 1\u20132 seconds \u2014 \"AcmeCorp, we believe\" reads as an ad, which kills completion rate", "Voiceovers don\u2019t work", "Music was missing"], correct: 1 },
    { q: "Your LinkedIn Sponsored Content ad has low engagement despite being targeted precisely. The copy reads: \"Transform your business today with our innovative, next-gen AI solution.\" The most fundamental fix is:", opts: ["Add more emojis", "Rewrite with specific pain + named role + concrete outcome with numbers \u2014 generic adjectives trigger LinkedIn\u2019s \"this is an ad\" filter instantly", "Shorten to one sentence", "Add a discount"], correct: 1 },
    { q: "Comparing Problem-Solution, Testimonial-Led, and Benefit-Stack frameworks for a cold audience who\u2019s never heard of your brand, which tends to earn trust fastest and why?", opts: ["Benefit-Stack \u2014 lots of features reassure buyers", "Testimonial-Led \u2014 borrowed credibility from a real named customer compensates for the cold audience\u2019s zero prior relationship", "Problem-Solution \u2014 pain always wins", "All three perform identically"], correct: 1 },
    { q: "You\u2019re asked to recommend A/B test priorities for a campaign. Rank these by expected leverage:", opts: ["Button color > headline copy > primary text hook", "Primary text hook > creative/image > CTA phrasing > button color", "Button color > description > headline > hook", "Posting time > copy > creative"], correct: 1 },
  ],
  slides: [
