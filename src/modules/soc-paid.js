...
export const socPaidModule = {
  ...
  quiz: [
    { q: "A Meta ad: CTR 2.8% and CPA $142. Benchmarks: CTR 1.5%, CPA $55. What does the combination most likely indicate?", opts: ["The ad is performing beautifully", "The ad should be paused immediately", "Targeting is wrong", "The hook works (people click at nearly 2\u00d7 benchmark) but the post-click funnel breaks down \u2014 investigate the landing page or offer, not the ad creative"], correct: 3 },
    { q: "Five Meta ad variants after 72 hours. Variant C: CTR 1.1%, CPA $190. Variants A, B, D, E: CTR 2.1\u20133.4%, CPA $38\u201368. Correct next move?", opts: ["Pause everything and start over", "Increase all budgets equally", "Kill C, let A/B/D/E keep learning, and plan new variants built on the 2 clearest top performers", "Put the budget on C to rescue it"], correct: 2 },
    { q: "A B2B TikTok Spark Ad opens with a polished voiceover: \u201cAt AcmeCorp, we believe\u2026\u201d Completion rate is 4% at 3 seconds. Why?", opts: ["Spark Ads demand UGC-style native openers with a pattern interrupt inside the first 1\u20132 seconds; a corporate intro is instantly flagged as an ad and scrolled past", "TikTok audiences don\u2019t buy B2B", "Voiceovers never work on TikTok", "Background music was missing"], correct: 0 },
    { q: "A LinkedIn Sponsored Content ad is precisely targeted but shows low engagement. Copy: \u201cTransform your business today with our innovative, next-gen AI solution.\u201d Most fundamental fix?", opts: ["Add emojis", "Rewrite with a specific pain + named role + concrete outcome with numbers \u2014 generic adjectives trigger LinkedIn users\u2019 \u201cthis is an ad\u201d filter instantly, tanking dwell time", "Shorten to one sentence", "Add a 10% discount"], correct: 1 },
    { q: "For a COLD audience that has never heard of your brand, compare Problem-Solution, Testimonial-Led, and Benefit-Stack frameworks. Which earns trust fastest and why?", opts: ["Benefit-Stack \u2014 more features reassure buyers", "Problem-Solution \u2014 pain always converts first", "All three perform identically on cold traffic", "Testimonial-Led \u2014 borrowed credibility from a named real customer compensates for the cold audience\u2019s zero prior relationship with your brand"], correct: 3 },
    { q: "You\u2019re asked to rank A/B test priorities by expected leverage. Which ranking is closest to reality?", opts: ["button color > headline > primary text > creative", "button color > description > headline > hook", "primary text hook > creative/image > CTA phrasing > button color", "posting time > copy > creative > hook"], correct: 2 },
  ],
  slides: [
