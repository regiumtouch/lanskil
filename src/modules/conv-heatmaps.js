...
export const convHeatmapsModule = {
  ...
  quiz: [
    { q: "A click map shows 40% of clicks hitting a non-link heading. Diagnosis?", opts: ["Nothing unusual \u2014 users click everything", "Analytics bug", "Visitors expect the heading to be clickable \u2014 either it looks like a link/button (fix the styling) or they\u2019re trying to jump past it (consider adding an actual anchor/CTA at that point)", "Ignore it"], correct: 2 },
    { q: "Scroll-depth data shows 70% of visitors leave within the first viewport. Most productive next step?", opts: ["Add more images below the fold", "Watch 10 session recordings of visitors who bounced from the fold \u2014 behaviour tells you whether it\u2019s intent-mismatch, slow load, or value-prop failure, which point to different fixes", "Add a pop-up to reduce bounce", "Redesign the footer"], correct: 1 },
    { q: "\u201cRage clicks\u201d typically indicate:", opts: ["Visitors are excited", "Random behaviour", "Nothing meaningful", "Users clicking repeatedly on something they expected to work but didn\u2019t \u2014 a dead button, unclickable element, or failed submit; these are UX bugs hidden behind aggregate data"], correct: 3 },
    { q: "Recordings show visitors scrolling fast past your testimonial section. Most likely cause?", opts: ["They look like stock-quote testimonials (headshot + generic phrase) that don\u2019t pattern-break the scroll \u2014 replace with named outcomes, numbers, or a non-standard visual format", "The testimonials are too good to be true", "The page is too long", "Visitors dislike success stories"], correct: 0 },
    { q: "Form analytics: 60% abandon at the 3rd field (phone number). Diagnostic call?", opts: ["Require phone anyway \u2014 quality over quantity", "Require it earlier in the form", "Either remove the phone field, make it optional, or move it to AFTER the high-intent step \u2014 every additional field compounds drop-off, and phone specifically triggers \u201csales will call me\u201d anxiety", "Ignore the data"], correct: 2 },
    { q: "Highest-ROI use of session recordings is to:", opts: ["Watch every session", "Watch 10\u201315 recordings of visitors who BOUNCED or ABANDONED \u2014 failure-path behaviour teaches more than success-path behaviour because you learn WHY people leave", "Only watch converting visitors", "Never watch them"], correct: 1 },
  ],
  slides: [
