...
export const salesVslModule = {
  ...
  quiz: [
    { q: "Your 22-minute VSL loses 70% of viewers in the first 90 seconds. The avatar intro is strong. The product is revealed at 3:20. Diagnose:", opts: ["The VSL is too long overall", "Viewers don\u2019t like 22-min videos", "Intro needs faster music", "The product is revealed far too early \u2014 revealing the product name at 3:20 collapses the persuasion arc before problem + story + mechanism have done their work; viewers bail because the video starts feeling like an ad the moment they hear the pitch"], correct: 3 },
    { q: "A VSL hook opens: \u201CHi, I\u2019m [Name] and I\u2019ve spent 12 years in the coaching industry.\u201D You A/B test against: \u201CThree months ago, Priya\u2019s coaching business was 6 weeks from dead.\u201D Expected result:", opts: ["Resume-opener wins on authority", "They tie", "Story-opener wins decisively \u2014 credibility established through a named stakeholder with stakes holds attention; the resume opener activates the \u201Cthis is a sales pitch\u201D filter within 8 seconds regardless of how impressive the resume is", "Resume opens better for senior audiences"], correct: 2 },
    { q: "Your 25-min VSL converts at 2.1% on paid cold traffic. The offer reveal at minute 22 is strong, but you notice 40% drop-off between minutes 14\u201317. That window contains your solution-mechanism explanation. Most likely fix:", opts: ["Rewrite minutes 14\u201317 with concrete visuals, named cases, and shorter beats \u2014 that section is where mechanism lives, and mechanism explained abstractly is where VSLs leak; this is about pacing + specificity, not re-sequencing", "Move the offer forward to minute 14", "Cut the VSL to 15 min", "Add music in that window"], correct: 0 },
    { q: "You\u2019re writing a VSL for an $8,000 B2B coaching programme. Optimal relative time spent in each section:", opts: ["Equal time to each", "Heavier weight on story + proof (roughly 40\u201350% of runtime) because at that ACV the reader needs sustained credibility; the offer + close should be tight (3\u20134 min); hook is short but disproportionately revised", "50% on offer, 50% on product demo", "Frontload most of the runtime on the hook"], correct: 1 },
    { q: "A VSL viewer hits the Buy button at minute 24 without watching minutes 10\u201320. Most likely explanation:", opts: ["The VSL isn\u2019t working", "They won\u2019t stick as a customer", "The viewer got lucky", "They were already high-intent (Most-Aware in Schwartz terms) before pressing play; VSLs that convert well serve multiple awareness levels \u2014 hot viewers skip ahead, cold ones watch through. Both should be able to buy"], correct: 3 },
    { q: "Your VSL cost-per-acquisition is creeping up month over month. Hook, offer, and price unchanged. Most likely root cause:", opts: ["Paid platform is broken", "Offer is outdated", "Audience fatigue \u2014 the same hook + creative against the same audience eventually saturates the hot portion; the fix is creative refresh (new hook angles, new story leads) not VSL-structure change", "VSLs always decay"], correct: 2 },
  ],
  slides: [
