...
export const convMindsetModule = {
  ...
  quiz: [
    { q: "A visitor lands on your pricing page from a Google search for \u201c[your competitor] alternative.\u201d Their mindset is best described as:", opts: ["Early awareness \u2014 they need category education", "Transactional \u2014 ready to buy this minute", "Late-stage commercial investigation \u2014 they\u2019ve already decided the category and are actively choosing a vendor", "Casual browsing"], correct: 2 },
    { q: "On a commercial-intent landing page, Version A leads with brand story; Version B leads with a specific outcome + named number. A converts at 1.2%, B at 3.8%. Why?", opts: ["Brand story always underperforms", "B is shorter", "A has worse copy in general", "Commercial-intent visitors want the verdict fast; B delivers it in the first 10 words, while A buries the answer under narrative the visitor didn\u2019t come for"], correct: 3 },
    { q: "Friction on a landing page is most accurately measured as:", opts: ["The sum of cognitive + emotional + operational steps between landing and converting \u2014 unanswered objections, missing proof, and extra form fields each add friction", "Page load time alone", "Word count", "Number of images"], correct: 0 },
    { q: "A landing page has a strong-looking hero but 60% of visitors never scroll past it. Most likely explanation?", opts: ["Page is too long overall", "Either the hero doesn\u2019t confirm the visitor\u2019s specific intent, or it resolves intent fully but offers no reason to read further \u2014 both are above-the-fold design problems", "Too many images", "Wrong font choice"], correct: 1 },
    { q: "Awareness-stage copy and decision-stage copy differ fundamentally because:", opts: ["Awareness is longer, decision is shorter", "Only the tone differs", "Decision copy must always be a single sentence", "Awareness visitors are still learning; decision visitors are comparing vendors and need proof, specificity, and friction removal \u2014 not education"], correct: 3 },
    { q: "Across a large number of landing-page audits, the single most common conversion-killing copy mistake is:", opts: ["Using too many colors", "Not enough animations", "Writing copy that describes the PRODUCT instead of what the VISITOR gets \u2014 feature-first copy reliably loses to outcome-first copy", "Wrong font size"], correct: 2 },
  ],
  slides: [
