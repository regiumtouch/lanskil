...
export const bizLongGameModule = {
  ...
  quiz: [
    { q: "Two 5-year-in copywriters. Writer A: took every client, averages $180K, portfolio spans 40 industries. Writer B: said no to 30% of inquiries in years 1-3, averages $340K, portfolio is 15 deep niche pieces. Structural reason for the gap:", opts: ["Writer B is just better at craft", "Writer A\'s yes-to-everything filled capacity with mid-tier work, producing mid-tier referrals and locking rates at mid-tier; Writer B\'s selectivity preserved capacity for right-fit clients whose outcomes compound into premium referrals", "Writer A had worse luck", "Niche is irrelevant at 5-year mark"], correct: 1 },
    { q: "A past client from 2 years ago cold-emails: \"My friend is looking for copy help - mind if I connect you?\" You are 95% booked. Correct response:", opts: ["Decline the intro to protect capacity", "Accept the intro, have the call, quote at your current rate with a 3-4 week timeline; warm referral calls are rare assets and even if this one does not close, the referrer is reinforced - turning them down risks closing a 5-year referral channel", "Accept but discount heavily", "Ignore the email"], correct: 1 },
    { q: "An engagement ends badly - client disputes the final invoice and leaves unhappy despite you doing clean work. A year later they resurface as a reference request from a prospect. Most sophisticated handling:", opts: ["Bad-mouth them to protect yourself", "Offer the prospect 2 other references without commenting on the disputed one; the prospect will form their own judgment, and bad-mouthing a former client follows you publicly and kills future references - graceful handling of bad endings compounds over decades", "Refuse to participate in any reference process", "Attack the former client publicly"], correct: 1 },
    { q: "Year 7 of your career. You realise 60% of current pipeline traces back to 3 clients you took in year 2-3. Most actionable lesson for the next 7 years:", opts: ["Take more clients to increase the pool", "The compounding value of right-fit early clients is usually underestimated by 5-10x; invest disproportionately in the 10-20 clients most likely to produce decade-long referrals, and ruthlessly decline clients that look unlikely to", "Ignore past-client attribution", "Switch niches to diversify"], correct: 1 },
    { q: "You have held rates flat for 2 years because 4 long-term clients \"would leave if I raised.\" You do the math: they collectively generate $14K/mo vs new clients at equivalent scope paying $22K/mo. Honest strategic call:", opts: ["Hold rates - existing relationships are priceless", "Raise on existing clients with 60-day notice; even if all 4 leave (unlikely), the $8K/mo gap at new-client rates refills within 3-4 months, and under-pricing below market is silent income loss that compounds for years", "Only raise on new clients, never existing", "Raise 100% to force them out"], correct: 1 },
    { q: "You publish consistently on LinkedIn for 14 months. Inbound has not materialised. A coach says \"quit public writing - it clearly does not work for you.\" Most accurate assessment:", opts: ["Quit - 14 months is plenty of data", "Public-writing inbound typically takes 18-36 months to reach meaningful flow; 14 months of consistent niche-aligned content is often the quarter before the breakthrough - quitting at 14 months is the single most common freelance content-marketing failure mode", "Switch platforms every 3 months", "Post 10x more content daily"], correct: 1 },
  ],
  slides: [
