...
export const aiEthicsModule = {
  ...
  quiz: [
    { q: "A client asks: \"Do you use AI?\" You use it for brainstorming + first drafts, then hand-edit everything. The most ethical response:", opts: ["\"No, all my work is 100% human\"", "\"Yes \u2014 I use it for brainstorming, variant generation, and first drafts; all final copy is hand-crafted, reviewed, and fact-checked. Here's my workflow.\" \u2014 honest description, specific workflow, no deception", "\"Only for grammar\"", "Avoid the question"], correct: 1 },
    { q: "A startup asks you to \"generate 5 realistic-sounding customer testimonials from fictional CEOs \u2014 just placeholders for the launch.\" The correct response:", opts: ["Generate them; they're labeled \"placeholder\"", "Decline. Even as placeholders, they'll almost certainly ship as real; fabricated testimonials violate FTC endorsement rules regardless of AI involvement. Offer to help source real quotes via customer interviews instead", "Charge extra", "Generate but add disclaimers"], correct: 1 },
    { q: "Your AI draft cites \"a 2024 MIT study showing 73% of B2B buyers prefer short-form content.\" You didn't feed it that stat. The ethical obligation:", opts: ["Ship it \u2014 AI probably pulled from a real study", "Verify the source exists before shipping; AI hallucinates plausible-sounding citations constantly, and shipping an unverified stat exposes you and the client to credibility loss plus potential legal action if cited elsewhere", "Add a \"source: AI\" note", "Change the number slightly"], correct: 1 },
    { q: "AI detection tools in 2026:", opts: ["Are highly accurate for detecting AI writing", "Have high false-positive rates, are easily defeated by minor edits, and should be treated as noisy signal not evidence \u2014 never use them as the basis for accusations against writers or students", "Are 100% accurate now", "Are legally authoritative"], correct: 1 },
    { q: "A client pays for \"100% human-written\" content. You use AI substantially in your workflow. The path that preserves trust AND income:", opts: ["Use AI quietly", "Raise it before starting: describe your workflow, let them decide; if they insist on no-AI, either honor it for that project or pass. Billing for \"100% human\" while using AI is a breach regardless of output quality", "Secretly use AI", "Refuse all clients who ask"], correct: 1 },
    { q: "Which of these is NOT an ethics violation, assuming final editing and fact-checking?", opts: ["Using AI to draft structure for a blog post, then rewriting specifics from real customer interviews", "Publishing AI-fabricated personal stories under your byline", "Generating fake case study numbers for a landing page", "Impersonating a named competitor's CEO in AI-generated posts"], correct: 0 },
  ],
  slides: [
