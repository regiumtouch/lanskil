...
export const bizPricingModule = {
  ...
  quiz: [
    { q: "You price by the hour at $120. You just shipped a sales page in 6 hours that your client says is generating $80K/month in new pipeline. Your invoice: $720. Structural problem:", opts: ["Your hourly rate is too low - raise to $250/hr", "The pricing model mis-prices the value; a $720 fee for a $960K/year pipeline contribution is a value leak the hourly model makes structurally inevitable - fix the model, not the rate", "Sales pages should never exceed 6 hours", "$720 is fair because that is what 6 hours of work costs"], correct: 1 },
    { q: "A prospect wants you on a $8K/mo retainer for \"marketing copy as needed.\" Biggest red flag in that scope:", opts: ["$8K/mo is too low", "\"As needed\" has no defined deliverable ceiling - scope creep is mathematically certain; retainers only work when the monthly output is explicit (e.g., 4 blog posts + 1 newsletter + 6 LinkedIn posts)", "Retainers are always a trap", "Monthly billing is worse than project billing"], correct: 1 },
    { q: "You quote $12,000 for a sales page. Prospect responds: \"that is way above our budget - can you do $4,000?\" Most strategically sound response:", opts: ["Accept $4K to secure the engagement", "Hold the $12K price; offer a reduced scope at $4K (e.g., sales page skeleton only, no hero copy, no A/B variants) - discounting the same scope trains future buyers to expect 67% off and damages your next three quotes", "Counter at $6K to split the difference", "Walk away without a counter-proposal"], correct: 1 },
    { q: "You moved from hourly ($90) to project pricing 6 months ago. Current average effective hourly is $140. A friend asks if you should move to value-based. Honest readiness check:", opts: ["Yes - always move up the pricing stack ASAP", "Value-based requires attributable business outcomes from prior work (\"this page drove $X in pipeline\"); without 2-3 client case studies quantifying revenue impact, value-based pitches land as arbitrary markups and lose deals", "No - stay on project pricing forever", "Only retainers come after project pricing"], correct: 1 },
    { q: "You quote $5K project. A junior writer quotes $1,200 for the same scope. The client hires the junior. 8 weeks later they come back, copy did not work, and ask you to fix it. Your best move:", opts: ["Accept the fix job at $5K to win the long game", "Quote the fix at your rate PLUS a premium for inherited-work complexity ($7-9K), not a discount; discounting here teaches the client that your rate was always negotiable, and fixing other people\'s work is harder than writing from scratch", "Charge only for hours actually worked", "Refuse the job entirely"], correct: 1 },
    { q: "You have been charging $4K per landing page for 18 months. Demand has grown to a 6-week waitlist; 3 recent clients volunteered \"that was a steal.\" When to raise rates, and to what:", opts: ["Never raise on existing clients - only new ones", "Raise now to $6-7K for new clients (demand + verbal price signals justify it); grandfather existing clients for one cycle then notify 60 days before next renewal; a 6-week waitlist at $4K is below-market and losing you $100K+/yr", "Raise to $20K immediately across all clients", "Wait another year for more data"], correct: 1 },
  ],
  slides: [
