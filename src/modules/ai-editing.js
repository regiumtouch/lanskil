...
export const aiEditingModule = {
  ...
  quiz: [
    { q: "You paste an AI draft into your editor. Before reading line-by-line, the fastest tell it's AI-generated is:", opts: ["Perfect grammar", "Adjective stacks of 3+ (\"innovative, cutting-edge, seamless\") + hedging verbs (\"can help,\" \"may improve\") + zero named specifics \u2014 these co-occur in AI-default output in a way they rarely do in human drafts", "Word count", "Em-dash usage"], correct: 1 },
    { q: "An AI draft passes the specificity pass (every adjective has been swapped for a number). On re-read it still feels robotic. The likeliest remaining issue:", opts: ["Font weight", "Uniform sentence rhythm \u2014 AI defaults to 15\u201320 word sentences in parallel structure; varying length + adding fragments is the audible fix", "Grammar errors", "Too few adjectives"], correct: 1 },
    { q: "You edit AI copy and it reads well. You apply the \"remove brand name\" test \u2014 the copy could describe 3 competitors. What does this tell you?", opts: ["The copy is fine", "You polished the surface but didn't replace generic claims with claims only this brand could make; specificity pass needs another pass with real materials", "Brand name test is unreliable", "Add more adjectives back"], correct: 1 },
    { q: "Rank these edits by conversion impact on an AI draft: (A) fix 3 typos; (B) swap \"thousands of customers\" for \"847 Series-A teams\"; (C) delete 4 redundant adjectives; (D) change the font.", opts: ["A > B > C > D", "B > C \u226b A > D \u2014 named specifics + adjective cuts are the high-leverage moves; typos and font don't change the copy's persuasion", "C > A > B > D", "All equal"], correct: 1 },
    { q: "You see \"Unlock your team's potential with seamless integration\" in an AI draft. Best rewrite:", opts: ["\"Empower your team with seamless integration\"", "\"Your Head of Ops imports your Salesforce data in 4 min \u2014 no engineering ticket\"", "\"Enable your team through cutting-edge integration\"", "\"Leverage your team's capability with integration\""], correct: 1 },
    { q: "The final editing move before shipping AI-drafted copy should be:", opts: ["Another AI pass", "Read it aloud \u2014 AI copy has an audible cadence when spoken; if any sentence sounds like a brochure, rewrite until it sounds like a person you'd trust", "Word-count check", "Grammar checker"], correct: 1 },
  ],
  slides: [
