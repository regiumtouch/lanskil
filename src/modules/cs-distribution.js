...
export const csDistributionModule = {
  ...
  quiz: [
    { q: "Team A spends 80% of hours creating, 20% distributing. Team B spends 40/40/20 (create/distribute/iterate). Same content quality. Predict the 90-day outcome gap:", opts: ["Team A reaches more people because they produce more", "Team B typically reaches 3\u20135\u00D7 more \u2014 same quality, drastically more distribution multiplies reach", "No difference", "Team A is more efficient"], correct: 1 },
    { q: "You publish a blog, share the link once on LinkedIn and Twitter on day 1, then move on. On day 14 the piece has 180 views. Diagnosis:", opts: ["The piece wasn\u2019t interesting enough", "You treated distribution as an event, not a 30-day process; same piece with a proper distribution plan typically hits 5\u201310\u00D7 more reach", "Wrong day of week", "Too long"], correct: 1 },
    { q: "Rank these distribution channels by platform risk (highest risk = most to lose if platform changes): Email list, LinkedIn followers, TikTok followers, Your blog", opts: ["Email > Blog > LinkedIn > TikTok", "TikTok > LinkedIn > Email \u2248 Blog \u2014 third-party platforms can change rules, deprioritise you, or ban accounts; owned channels are the durable audience", "Blog > Email > TikTok > LinkedIn", "They\u2019re all equivalent"], correct: 1 },
    { q: "Repurposing means which of these?", opts: ["Copy-pasting the same post to 5 platforms", "Taking one core idea and producing 5 platform-native adaptations \u2014 different length, voice, format per platform", "Republishing old content unchanged annually", "Auto-generating variations with AI"], correct: 1 },
    { q: "Which 30-day distribution sequence is strongest for a single long-form piece?", opts: ["Day 1 link share everywhere + nothing else", "Day 1 publish + email + native social versions / Days 2\u20137 3 angle-pulls as separate posts / Days 8\u201330 newsletter cite, podcast mention, community share, repost with new intro", "Daily reshares of the same link", "Wait 90 days, then repost"], correct: 1 },
    { q: "A creator has 12,000 followers but only 200 email subscribers. What\u2019s their biggest strategic weakness?", opts: ["They need more followers", "Their owned audience (email) is under-invested relative to rented audience (followers) \u2014 a platform pivot could wipe the 12,000 overnight", "They need more platforms", "Nothing is wrong"], correct: 1 },
  ],
  slides: [
