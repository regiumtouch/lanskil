...
export const csMeasurementModule = {
  ...
  quiz: [
    { q: "Dashboard: page views +40% QoQ, pieces published +25%, content-attributed pipeline flat for 4 quarters. How would a sharp CMO fairly describe this?", opts: ["Strong growth \u2014 don't change anything", "Output is up, outcomes are flat \u2014 the program is producing motion but not business value; the right response is a rebalance toward the pillars/formats that convert, not more publishing", "Needs more traffic to convert", "Reporting is working \u2014 nothing to fix"], correct: 1 },
    { q: "Which pair is a clean leading + lagging indicator for a B2B demand-gen content program?", opts: ["Page views + social likes", "Qualified demo requests from content CTAs (leading) + content-attributed pipeline $ (lagging) \u2014 one predicts the other, and both trace to revenue", "Posts published + follower count", "Word count + bounce rate"], correct: 1 },
    { q: "Quarterly audit: Pillar A drove 60% of outcomes, Pillar B drove 3%. Correct response:", opts: ["Invest more in Pillar B to rescue it", "Kill or fundamentally redesign Pillar B and reallocate its capacity to Pillar A or a new bet \u2014 a failing pillar eats weekly capacity and the opportunity cost is what Pillar A could have compounded with that time", "Leave both and reassess next year", "Blame the writer assigned to B"], correct: 1 },
    { q: "Leadership asks in a 15-minute review: \"what did content do this quarter?\" Most effective format:", opts: ["Open the 20-chart dashboard and walk through each", "One lagging outcome ($412K attributed pipeline, +23% QoQ) + 2 leading indicators + one named customer story \u2014 executives remember one number and one story, and that's what defends next year's budget", "Total impressions for the quarter", "Pieces published count"], correct: 1 },
    { q: "Over 90 days the team shipped 18 pieces; 3 drove 70% of attributed outcomes. Correct response:", opts: ["Keep producing at the same volume across all pillars", "Analyse what the 3 winners share (format, audience, POV, hook, distribution pattern) and explicitly plan more pieces with those attributes \u2014 the signal is that the program has a repeatable pattern inside it", "Kill all content and restart", "Ignore it \u2014 small sample"], correct: 1 },
    { q: "Which of these is the clearest vanity metric in a primary dashboard?", opts: ["Qualified leads attributed to content", "Content-attributed ARR", "Total impressions with no source breakdown or conversion linkage", "Newsletter active-subscriber rate"], correct: 2 },
  ],
  slides: [
