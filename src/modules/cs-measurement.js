...
export const csMeasurementModule = {
  ...
  quiz: [
    { q: "A leading indicator is:", opts: ["A metric that comes out first in your dashboard", "A metric that predicts a future business outcome (e.g. email signups predicting pipeline)", "Always revenue", "The most important metric"], correct: 1 },
    { q: "The best number of metrics to track for a content programme is:", opts: ["1 lagging + 2\u20133 leading indicators", "20+ metrics across a full dashboard", "Just page views", "Whatever your boss asks for"], correct: 0 },
    { q: "A quarterly content audit should answer:", opts: ["Is my calendar full?", "Which pillars, formats, and channels produced the outcomes we actually care about \u2014 and which should we cut?", "Which competitors are beating us?", "What's trending?"], correct: 1 },
    { q: "When reporting to leadership, the single strongest metric to lead with is:", opts: ["Total page views", "Content-attributed revenue or pipeline", "Number of pieces published", "Social media likes"], correct: 1 },
    { q: "The right response to a pillar that consistently underperforms is:", opts: ["Produce more content on it", "Kill it and reallocate capacity to a pillar that works", "Change the writer", "Rebrand the pillar"], correct: 1 },
    { q: "A vanity metric is any number that:", opts: ["Grows every month", "Cannot be clearly linked to a business outcome", "Is easy to measure", "Comes from social media"], correct: 1 },
  ],
  slides: [
