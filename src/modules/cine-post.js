...
export const cinePostModule = {
  ...
  quiz: [
    { q: "You shot a dialogue scene in S-Log3 under mixed fluorescent + daylight. In Resolve, an inexperienced colorist jumps straight to applying a \u2018film emulation\u2019 LUT. The skin looks sickly. Why?", opts: ["The LUT is wrong for S-Log3 \u2014 all LUTs are proprietary", "Correction was skipped \u2014 the green fluorescent cast was never neutralized, so the creative look is stacking on top of broken footage; correct first, grade second", "S-Log3 cannot be graded to look natural", "The LUT should be applied on a separate timeline"], correct: 1 },
    { q: "You\'re shooting a narrative feature + the editor wants small files for the offline edit, but the DP insists the original capture be 4K ProRes 4444 or higher. Who\'s right, and why?", opts: ["The editor \u2014 small files are all that matter in offline", "Both \u2014 shoot high-quality ProRes/RAW as the master; the editor works with transcoded proxies that online-conform back to the masters for final grade. Capture format protects the film long-term", "The DP \u2014 ProRes 4444 should be used for the offline edit too", "Neither \u2014 shoot H.264 and grade from that"], correct: 1 },
    { q: "Colorist is pushing the grade hard \u2014 shadows to teal, highlights warm. Skin on actors starts shifting toward orange/pink unnaturally. What\'s the professional fix?", opts: ["Reduce the intensity of the whole grade until skin looks normal", "Use an HSL qualifier or vector key to isolate skin tones + protect them on a separate node, then push the rest of the image however hard the creative call requires", "Grade each actor individually in separate timelines", "Accept it \u2014 strong looks always compromise skin"], correct: 1 },
    { q: "You\'re cutting a 2-minute emotional dialogue scene. Two takes are nearly identical. One has a slight focus hunt on the key line; the other is soft but stable. Which do you cut to, and why?", opts: ["Always use the focus-hunt take \u2014 sharpness is everything", "The stable-but-slightly-soft take \u2014 audiences forgive mild softness far more than a visible focus shift, which breaks immersion; stability + performance win", "Cut between both to give the editor options", "Discard both and reshoot the line"], correct: 1 },
    { q: "DaVinci Resolve node structure: you have a correction node, a creative grade node, and a skin-protection key. What\'s the correct order of operations?", opts: ["Creative grade \u2192 correction \u2192 skin protection", "Correction \u2192 creative grade \u2192 skin protection (key pulls from corrected footage; grade is applied with skin masked out)", "Skin protection \u2192 correction \u2192 creative grade", "Order doesn\u2019t matter \u2014 nodes are commutative"], correct: 1 },
    { q: "The colorist + director want the DP\'s input on the grade but the DP\'s vague feedback (\u2018more cinematic, less flat\u2019) stalls the session. What feedback format actually moves the grade forward?", opts: ["Trust the colorist + director \u2014 step out of the session", "Reference specific frames in specific shots (\u2018this shot feels 1 stop over in the highlights, skin is going magenta in CU 14, the shadow roll-off from that Deakins reference would serve the moment better here\u2019) \u2014 specifics unblock; adjectives stall", "Approve everything and give notes over email later", "Insist on re-shooting any shot that doesn\u2019t grade easily"], correct: 1 },
  ],
  slides: [
