...
export const aiMindsetModule = {
  ...
  quiz: [
    { q: "You're auditing your team's output. Writer A uses AI for hooks AND for writing named customer quotes. Writer B uses AI for first-draft structure + variant generation but writes closes + customer stories by hand. Six months in, B's pieces convert 2.3\u00d7 better. The likeliest cause:", opts: ["B writes faster than A", "A is letting AI handle the irreplaceable 20% (voice-carrying moments + unfalsifiable specifics) where commodity output costs conversion; B is allocating AI only where it doesn't hurt", "B uses a better AI model", "A's prompts are too short"], correct: 1 },
    { q: "A founder says: \"AI writes my LinkedIn posts in 2 minutes. Engagement is fine.\" You check: 850 impressions, 3 likes, one bot comment. Your diagnosis:", opts: ["Engagement is fine \u2014 keep shipping", "\"Fine\" is the tell \u2014 AI-default output is engineered for the statistical middle, which is the graveyard; absence of named people, real numbers, or contrarian stakes is why reach stalls", "Post more frequently", "Switch AI models"], correct: 1 },
    { q: "You have 45 minutes to produce a 500-word product description. Which sequence tends to produce the highest-converting output?", opts: ["AI drafts the final; you fix typos and ship", "Human gathers 2 real customer quotes + 1 real metric (15 min) \u2192 AI drafts from that material (10 min) \u2192 human specificity + voice pass (20 min)", "Human writes 500 words from scratch (45 min)", "AI generates 10 drafts; you pick the best verbatim"], correct: 1 },
    { q: "Which task is the BEST candidate for AI to handle end-to-end with minimal human touch?", opts: ["The hero headline on a $40k-ACV landing page", "A named customer success story for your case-study library", "Generating 30 subject-line variants for an A/B test within an already-established voice", "The founder's personal LinkedIn post about getting fired"], correct: 2 },
    { q: "A client contract says \"human-written content only.\" You've been using AI for brainstorming + variant generation, then hand-editing. The ethical move:", opts: ["Stay quiet \u2014 your final output is human-crafted", "Raise it explicitly: describe your actual workflow to the client and renegotiate the clause, or stop using AI on their work; \"only\" makes silence a misrepresentation", "Only use AI when they won't notice", "Change the contract unilaterally"], correct: 1 },
    { q: "You read a landing page, remove the brand name, and notice it could describe 12 competitors equally well. Adjective density is low; grammar is clean. What's the likely failure mode?", opts: ["Typos", "The human 20% is missing \u2014 no named customers, no proprietary numbers, no stated POV; the copy is grammatically competent but strategically generic because the writer skipped research, not editing", "Wrong font", "Length is off"], correct: 1 },
  ],
  slides: [
