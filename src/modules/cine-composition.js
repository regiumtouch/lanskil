...
export const cineCompositionModule = {
  ...
  quiz: [
    { q: "An interrogation scene: detective stands, suspect sits. The director wants the suspect to feel cornered without any dialogue telling us so. Which composition best delivers that?", opts: ["Low angle on the detective + high angle on the suspect, with the detective pushed to frame edge and empty space looming over the suspect", "Symmetric head-on framing of both, rule-of-thirds on each, neutral eye-level \u2014 let the performance carry it", "Shallow focus 85mm CU on the suspect with bokeh behind, detective out of frame entirely", "Wide 24mm two-shot at eye level so audience sees the whole room"], correct: 0 },
    { q: "You frame a walking subject with 5% of lead room in their direction of travel and 40% behind them. What\u2019s the likely audience read?", opts: ["Clean, textbook lead-room composition that feels pleasant and forward-moving", "Unease or dread \u2014 violating lead room makes it feel like the subject is walking into something confined or walled off", "Nothing \u2014 lead room is a dated rule most films ignore", "Comic / whimsical because the subject is about to walk out of frame"], correct: 1 },
    { q: "A 90-second short for Instagram Reels: the brief says \"feel like a mini feature film.\" Your first instinct is to shoot 2.39:1 and center-crop. Why is that probably wrong?", opts: ["2.39:1 is a licensed format that requires distribution approval", "9:16 delivery means you\u2019ll waste 60%+ of the vertical canvas on black bars; compose for vertical-native composition and use other cues (lighting, pacing, palette) to feel cinematic", "You can\u2019t shoot cinemascope on consumer cameras without anamorphic glass", "2.39:1 is only appropriate for projects that will be graded in a finishing house"], correct: 1 },
    { q: "A single-subject dialogue close-up feels \"flat\" even though lighting + lens are good. What\u2019s the most likely compositional miss?", opts: ["The subject isn\u2019t placed on a rule-of-thirds line, so the eye has nowhere to go", "There\u2019s nothing in the foreground \u2014 no layer between camera + subject to create depth in the 2D frame", "The aspect ratio is 16:9 instead of 2.39:1", "The subject\u2019s headroom is too generous"], correct: 1 },
    { q: "You shoot a conversation between two characters facing each other. In shot A the camera is on their left; in shot B you cross to the right side for the reverse. Cut together, audiences feel disoriented. What rule did you violate?", opts: ["The 30\u00B0 rule \u2014 you didn\u2019t change angle enough between cuts", "The 180\u00B0 axis of action \u2014 crossing the line flips screen direction and makes eyelines feel wrong", "Rule of thirds \u2014 your cut points aren\u2019t on thirds", "Lead-room rule \u2014 you didn\u2019t give either character enough look space"], correct: 1 },
    { q: "Director wants \"Wes Anderson vibes\" for a quirky product film. You shoot dead-centre symmetric frames. The footage feels like a weak imitation. What\u2019s most likely missing?", opts: ["A wider aspect ratio \u2014 Anderson uses 2.39:1 for those frames", "Matching visual weight on both sides of the centered subject + production design in the symmetry \u2014 centering alone isn\u2019t the look; the controlled world around the subject is", "Heavy grain added in post \u2014 his signature is the grain", "Pastel grade \u2014 without the color work, symmetry reads as static"], correct: 1 },
  ],
  slides: [
