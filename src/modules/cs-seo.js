...
export const csSeoModule = {
  ...
  quiz: [
    { q: "Your \"complete guide to X\" ranks on page 1 but click-through is half the position-adjusted prediction. Most likely diagnosis?", opts: ["Guide is too short", "Intent mismatch \u2014 the searcher wants a quick answer or a comparison, not a 4,000-word guide, and the title + first 150 words don't directly answer the question; search rewards intent match over comprehensiveness", "Not enough keywords in the H1", "Wrong domain authority"], correct: 1 },
    { q: "Competitor outranks you with objectively thinner content. Their page has: named author with visible credentials + 3 original data points + recent publish date. Yours has none. Most likely root cause:", opts: ["Their keyword targeting is tighter", "E-E-A-T signals \u2014 Google and AI search weight experience, expertise, authoritativeness, and trust heavily in 2026; a thinner page with credibility beats a thicker page without it", "Their site is older", "Paid backlinks"], correct: 1 },
    { q: "Rank these by modern SEO impact: (A) keyword density 2\u20133%, (B) the first 150 words directly answer the searcher's question, (C) named author byline with credentials, (D) 3,000-word length.", opts: ["A > D > C > B", "B > C > D > A \u2014 intent-match and E-E-A-T are now the dominant ranking signals; keyword density is near-irrelevant, and length is only weakly correlated with ranking", "All equal", "D > A > C > B"], correct: 1 },
    { q: "A Google AI Overview cites 4 sources on a query you rank for. Your piece answers the intent but has no named author, no publish date, no verifiable numbers. Why is it unlikely to be cited?", opts: ["Undated articles aren't indexed", "AI Overviews favour content that is citeable \u2014 named author, visible date, verifiable specific claims; unattributable prose is hard for the model to lift with confidence, even if the content is good", "Wrong CMS", "AI only cites paid placements"], correct: 1 },
    { q: "Search intent on \"best CRM for solopreneurs\" is primarily:", opts: ["Navigational \u2014 user looking for a specific site", "Commercial investigation \u2014 user is comparing options before purchase, so a comparison/listicle with honest trade-offs outperforms a how-to tutorial or a sales page", "Transactional \u2014 immediate purchase", "Informational \u2014 wants background"], correct: 1 },
    { q: "You have 90 days to move rankings with ZERO new content. Highest-leverage 6 moves on existing pages?", opts: ["Swap themes, buy backlinks, shorten all pages, add pop-ups", "Rewrite intros to answer the question in the first 150 words + add named author bylines + insert 3 first-hand data points per piece + restructure with H2s + internal-link 3\u20135x + refresh publish dates with real updates", "Increase keyword density to 3\u20134%", "Nothing \u2014 rankings need new content"], correct: 1 },
  ],
  slides: [
