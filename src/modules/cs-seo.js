...
export const csSeoModule = {
  ...
  quiz: [
    { q: "You write a \"complete guide to X\" that ranks on page 1 but clicks are way below prediction. Intent diagnostic: what\u2019s the likeliest issue?", opts: ["The guide is too short", "Intent mismatch \u2014 the searcher wants a quick answer or comparison, not a 4,000-word guide; the first 150 words don\u2019t directly answer the question", "Not enough keywords", "Wrong domain"], correct: 1 },
    { q: "Your competitor out-ranks you with thinner content. Their page has a named author with credentials + 3 original data points + publish date. Yours has none of those. Most likely root cause:", opts: ["Their keywords are better", "E-E-A-T signals \u2014 Google (and AI search) weight Experience, Expertise, Authoritativeness, and Trust signals heavily in 2026; thin without credibility still beats thick without credibility", "Their site is older", "Luck"], correct: 1 },
    { q: "Rank these by modern SEO impact: (A) keyword density 2\u20133% (B) first 150 words directly answer the question (C) named author byline (D) 3,000-word length", opts: ["A > D > C > B", "B > C > D > A \u2014 intent-match and E-E-A-T are dominant signals; keyword density is near-irrelevant; length alone is weakly correlated", "All equal", "D > A > C > B"], correct: 1 },
    { q: "An AI Overview cites 4 sources. Your piece has a clear intent answer but no dates, no author, no verifiable numbers. Why is it unlikely to be cited?", opts: ["Articles without dates can\u2019t be indexed", "AI engines favour content that is citeable \u2014 named author, date, verifiable data, specific claims; un-attributable prose is harder to confidently lift", "You\u2019re on the wrong CMS", "AI only cites paid sources"], correct: 1 },
    { q: "Search intent on \"best CRM for solopreneurs\" is primarily:", opts: ["Navigational \u2014 they\u2019re looking for a specific site", "Commercial investigation \u2014 they\u2019re comparing before buying, so a listicle/comparison piece outperforms a long tutorial", "Transactional \u2014 they want to buy immediately", "Informational \u2014 they want background"], correct: 1 },
    { q: "You have 90 days to move rankings with zero new content. Highest-leverage 6 moves are:", opts: ["Change themes, buy backlinks, add emojis, shorten all pages, add pop-ups, run ads", "Update intro to answer the question in 150 words + add named author + insert 3 first-hand data points + structure with H2s + internal-link 3\u20135x + refresh publish date", "Increase keyword density, add hidden text, stuff meta tags, buy domains", "Nothing; SEO is pure luck"], correct: 1 },
  ],
  slides: [
